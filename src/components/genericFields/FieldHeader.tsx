...
export interface IFieldHeaderProps<T> extends IGenericFieldProps<T>,IAppCtxDependentField<T> {
}

export class FieldHeader<T> extends React.Component<IFieldHeaderProps<T>,{}> {
  ...
  public render() : React.ReactElement<IFieldHeaderProps<T>> {
    ...
    <>
      ...
      <h3>
        {fieldInfo.Title}
        {fieldInfo.Description ? <InfoCallout>
